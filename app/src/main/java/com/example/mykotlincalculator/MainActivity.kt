...
class MainActivity : AppCompatActivity() {
    ...
    private var canAddOperation = false//so that we can not add 2 operation consecutively
    ...
    fun backSpaceAction(view: android.view.View) {
        ...
        if(length > 0)
            workingsTV.text = workingsTV.text.subSequence(0, length - 1)//subsequence return a string from start index to end-1
    }
